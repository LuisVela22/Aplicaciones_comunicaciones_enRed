...
public class Client extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            DatagramPacket contacto = new DatagramPacket(("<inicio>" + ui.getNombre()).getBytes(), ("<inicio>" + ui.getNombre()).length(), group, 4567);
            ...
            while (true) {
                if (ui.getStatus() == 0) {     //Lectura 
                    ...
                    DatagramPacket packet = new DatagramPacket(mensaje.getBytes(), mensaje.length(), group, 4567);
                    socket.send(packet);
                    ui.setStatus(0);
                }
            }
